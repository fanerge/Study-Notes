 ...
 * 中文转拼音
 * 
 * chinese2pinyin('中国') -> ZhongWen
 * chinese2pinyin('中国 Chinese') -> ZhongWen Chinese
 * chinese2pinyin('西安') -> XiAn
 * chinese2pinyin('先') -> Xian
 */
function chinese2pinyin(chinese) {
  if (chinese) {
...
const pinyin = (function() {
  ...
  Pinyin.fn = Pinyin.prototype = {
    init: function(ops) {
      this.options = Object.assign(options, ops)
    },
